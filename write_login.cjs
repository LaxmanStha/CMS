const fs = require('fs');
const content = String.rawimport { useState, useEffect, useRef } from 'react';
...
const Login = () => {
  ...
  return (
    <div className="min-h-screen bg-[#0B0F19] relative overflow-hidden flex flex-col md:flex-row">
      ...
      <div className="relative z-10 w-full md:w-1/2 flex flex-col items-center justify-center p-8 md:p-12 bg-gradient-to-br from-[#151C2C] to-[#111827]">
...
fs.writeFileSync('C:\\\\Users\\\\Chintu\\\\Documents\\\\Code\\\\langs\\\\C++ project\\\\frontend\\\\src\\\\pages\\\\Login.jsx', content);
